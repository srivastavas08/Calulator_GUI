...
for i in range(0,3):
    for j in range(0,3):
        btn_numbers[btn_text].place(x=25+j*90, y=120+i*70)
        print(j,i)
        btn_text +=1
...
for i in range(4):
    btn_operator[i].place(x=290,y=120+i*70)
#########################################other buttons############################
